...
# The RETURNS route and its collinearity were promoted to the package on 2026-09-09.
# Re-exported so this module's own API is unchanged for the five drivers that use
# BOTH routes to compare them -- there is one implementation, not two.
from lidar_diff_icp.groundtruth.same_line import (  # noqa: E402,F401
    collinearity_sigma, collinear_groups, _track_distance, marks_in_tiles,
    on_site_line, estimate_by_returns)
