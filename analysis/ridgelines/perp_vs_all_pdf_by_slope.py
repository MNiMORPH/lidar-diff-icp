#!/usr/bin/env python3
"""Core forest: PDF of near-slope-PERPENDICULAR ground-return elevations vs PDF of ALL
...
fig.suptitle("Core forest: near-slope-perpendicular vs all ground-return elevation PDFs, by slope",y=1.02)
fig.savefig("figures/refdatum/perp_vs_all_pdf_by_slope.png",dpi=100,bbox_inches="tight"); plt.close(fig)

print("core forest, ground-return elevation medians (mm); perp = incidence<=2deg:")
...
print("\nwrote figures/refdatum/perp_vs_all_pdf_by_slope.png")
