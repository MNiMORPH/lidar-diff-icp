...
- `analysis/investigations/help_next_steps/HELP_perline_slope_test.py` — per-flight-line test, test 3
- `analysis/investigations/help_next_steps/HELP_open_vs_forest_control.py` — open-vs-forest control, test 4 (decisive)
